...
@rem ##########################################################################
@rem
@rem  NoTimeToGetBadge startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and NO_TIME_TO_GET_BADGE_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NO_TIME_TO_GET_BADGE_OPTS%  -classpath "%CLASSPATH%" Main.main %*
...
:fail
rem Set variable NO_TIME_TO_GET_BADGE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%NO_TIME_TO_GET_BADGE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
